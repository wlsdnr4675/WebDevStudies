...
<tr>
   ...
   <td>
      <input name='writer' readonly value="${update.writer}" size="93"/>
   </td>
</tr>

<tr>
	<td align='center'>EMAIL</td>
	<td><input name='email' value="${update.email}" size="93"/></td>
</tr>

<tr>
	<td align='center'>SUBJECT</td>
	<td><input name='subject' value="${update.subject}" size="93"/></td>
</tr>
...
<tr>
	 <td colspan='2' align='center'>
		...
		<input type="button" value="CANCLE" onclick="f()">
 </td>
</tr>
